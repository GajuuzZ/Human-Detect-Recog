...
def imshow(path, title=None):
    """Imshow for Tensor."""
    im = plt.imread(path)
    im = resize(im, (128,256), interpolation=INTER_AREA)
    plt.imshow(im)
...
######################################################################
#result = scipy.io.loadmat('pytorch_result_f256x6(new).mat')
result = scipy.io.loadmat('mars-small128_result(new).mat')
